    ...
    <div class="sidebar-inner slimscrollleft">
      <div id="sidebar-menu">
        <ul>
          ...
          @if(\App\Helper\CustomHelper::canView('Create Role|Manage Role|Delete Role|View Role|List Of Role', 'Super Admin'))
            <li class="has_sub">
              <a class="waves-effect"><i class="mdi mdi-account-multiple"></i><span> Categories <span
                    class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
              <ul class="list-unstyled">
                {{--  @if(\App\Helper\CustomHelper::canView('Create Role', 'Super Admin'))
                ...
                @endif  --}}
                @if(\App\Helper\CustomHelper::canView('Manage Role|Delete Role|View Role|List Of Role', 'Super Admin'))
                  <li><a href="{{ route('category.list') }}">List of Category</a></li>
                @endif
              </ul>
            </li>
          @endif
          ...
          @if(\App\Helper\CustomHelper::canView('Create Role|Manage Role|Delete Role|View Role|List Of Role', 'Super Admin'))
            <li class="has_sub">
              <a class="waves-effect"><i class="mdi mdi-account-multiple"></i><span>Sub Categories <span
                    class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
              <ul class="list-unstyled">
                {{--  @if(\App\Helper\CustomHelper::canView('Create Role', 'Super Admin'))
                ...
                @endif  --}}
                @if(\App\Helper\CustomHelper::canView('Manage Role|Delete Role|View Role|List Of Role', 'Super Admin'))
                  <li><a href="{{ route('subcategory.list') }}">List of Sub Category</a></li>
                @endif
              </ul>
            </li>
          @endif
          ...
          @if(\App\Helper\CustomHelper::canView('Create Role|Manage Role|Delete Role|View Role|List Of Role', 'Super Admin'))
            <li class="has_sub">
              <a class="waves-effect"><i class="mdi mdi-account-multiple"></i><span>Child Categories <span
                    class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
              <ul class="list-unstyled">
                {{--  @if(\App\Helper\CustomHelper::canView('Create Role', 'Super Admin'))
                ...
                @endif  --}}
                @if(\App\Helper\CustomHelper::canView('Manage Role|Delete Role|View Role|List Of Role', 'Super Admin'))
                  <li><a href="{{ route('childcategory.list') }}">List of Child Category</a></li>
                @endif
              </ul>
            </li>
          @endif
